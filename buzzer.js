...
Buzzer.prototype = {
	light: function(controllerIndexes, value) {
	...
	lightOn: function(controllerIndexes) {
		this.light(controllerIndexes, 0xFF);
	},
	lightOff: function(controllerIndexes) {
		this.light(controllerIndexes, 0x0);
	},
	blink: function(controllerIndexes, times, duration) {
	...
	onPress: function(callback, controllerIndex, buttonIndex) {
		var key = 'all';
